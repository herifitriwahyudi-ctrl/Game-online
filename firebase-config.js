...
// Format angka tanpa Rp (untuk input)
...
// Cek apakah transaksi sudah pernah di-approve
async function isTransactionProcessed(userId, transactionId) {
  try {
    ...
    // Jika status approved atau rejected, transaksi sudah diproses
...
// Proses top up dengan aman (mencegah double approval)
async function processTopUpApproval(userId, transactionId, amount) {
  try {
    ...
    // Update saldo user dengan transaction (atomic)
...
// Proses withdraw dengan aman (mencegah double approval)
